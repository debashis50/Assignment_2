...
- **Content**:
  - Heading with different colored text, a main_heading, and a button styled as per design.
...
- **Arrow Button Group**: Center-aligned arrow buttons.Dont need any Hover effect. Its totbodyy optional🚩
- **Mobile Responsiveness**:
  - Cards will display in a single column, will took more than 90% of the device width.

---

### 4. Our story-heading Section
...
- **Structure**:
  - Three columns:
    1. Logo, site name, and about_link text as figma.
...
- hide the 1st  card on  smbody devices and show 4-6 card.
- hide arrow button group  from the statndard curriculam section.

### Explore Marquee & Use It
- Explore Marquee Tag. use it anywhere in your home_linkpage. make sure marquee is working.
---
